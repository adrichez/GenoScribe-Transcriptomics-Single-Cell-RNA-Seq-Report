  ...
  <ul>
    ...
    <li>
      ...
      <ul>
        ...
        <li>
          <a href="07-expresion-diferencial.html#tab3-seccion7.4">
            7.4. Análisis Definitivo en Poblaciones Consolidadas (Manual)
          </a>
          <ul>
            <li>
              <a href="07-expresion-diferencial.html#tab3-seccion7.4.1">
                7.4.1. Histórico de Versiones y Tipos de Contraste
              </a>
            </li>
            <li>
              <a href="07-expresion-diferencial.html#tab3-seccion7.4.2">
    ...
    <li>
      ...
      <ul>
        ...
        <li>
          ...
          <ul>
            <li>
              <a href="08-enriquecimiento.html#tab3-seccion8.3.1">
                8.3.1. Bases de Datos Analizadas (GO y KEGG)
              </a>
            </li>
            <li>
              <a href="08-enriquecimiento.html#tab3-seccion8.3.2">
