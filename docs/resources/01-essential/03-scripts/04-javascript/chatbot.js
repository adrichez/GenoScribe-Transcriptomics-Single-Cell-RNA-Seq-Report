...
import spanishResponses from "./spanish_responses.js";
import englishResponses from "./english_responses.js";
...
function checkPredefinedResponse(query) {
  ...
  // 🌍 Unir ambos diccionarios (prioridad: 1º Español, 2º Inglés)
  const allResponses = [...spanishResponses, ...englishResponses];
  ...
  for (let item of allResponses) {
    ...
    if (regex.test(q)) {
      ...
      return item.response; // Devuelve la primera que encuentre y corta el bucle
    }
  }
