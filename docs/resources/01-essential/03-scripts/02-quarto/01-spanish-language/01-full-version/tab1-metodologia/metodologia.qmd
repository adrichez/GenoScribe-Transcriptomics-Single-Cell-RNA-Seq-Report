...
<div class="toc">
  <ul>
    <li>
      <a href="#tab1-intro">Metodología y herramientas</a>
      <ul>
        <li>
...
<p>
  Esta sección detalla el marco técnico y metodológico subyacente a la generación de este informe, garantizando la total <strong>transparencia</strong> y <strong>reproducibilidad</strong> del análisis. El objetivo es documentar exhaustivamente el flujo de trabajo, desde el procesamiento bioinformático de los datos brutos hasta el renderizado automatizado del documento final, permitiendo a cualquier usuario comprender, auditar y replicar el proceso exacto.
</p>

<p>
  En el apartado <strong>1. Software y herramientas empleadas en el análisis</strong>, se describe el pipeline principal, que comprende el procesamiento primario de las lecturas mediante <strong>Cell Ranger (10x Genomics)</strong> y el posterior análisis transcriptómico a nivel unicelular utilizando el paquete <strong>Seurat</strong> en el entorno de programación <strong>R</strong>. A continuación, en <strong>2. Estructura de los datos y resultados generados</strong>, se detalla la organización de los directorios de salida y los archivos clave resultantes del experimento. 
</p>

<p>
  El apartado <strong>3. Generación automatizada del informe</strong> profundiza en la arquitectura modular del sistema, explicando paso a paso cómo <strong>Nextflow</strong> gestiona los directorios de ejecución e interactúa con <strong>Quarto</strong> a través de archivos de configuración esenciales como <code>params.yml</code> y <code>_quarto.yml</code>. Finalmente, la sección <strong>4. Manuales, repositorios y documentación complementaria</strong> proporciona acceso directo a los recursos técnicos oficiales de las herramientas empleadas para facilitar consultas adicionales.
</p>
